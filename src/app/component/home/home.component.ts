...
export class HomeComponent implements OnInit{
  ...
  logos = [
    { src: 'assets/img/marcas/tecnomin.webp', alt: 'tecnomin', url: 'https://tecnomindata.com/' },
    ...
    { src: 'assets/img/marcas/pachamama.webp', alt: 'pachamama', url: 'https://www.pachamamafarms.com/' },
    { src: 'assets/img/marcas/formavena.png', alt: 'formavena', url: 'https://formavenaconsergen.com/' },
    { src: 'assets/img/marcas/remanso.webp', alt: 'remanso', url: 'https://elremanso.com.pe/' },
